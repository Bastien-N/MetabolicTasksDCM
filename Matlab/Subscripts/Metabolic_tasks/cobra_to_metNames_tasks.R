...
outputFilePath <- "../../../../Data/MetabolicTasks_MACSBIO_v0.5_metNames.xlsx"#Path of the file to be written
#Also note that if the compartment is not indicated by a SINGLE letter after the ID, the scipt will fail

tasksCobra <- openxlsx::read.xlsx("../../../../Data/MetabolicTasks_MACSBIO_v0.5.xlsx",sheet = 1,sep.names = " ")
metIndex <- openxlsx::read.xlsx("../../../../Data/MetabolicTasks_MACSBIO_v0.5.xlsx",sheet = 2,sep.names = " ")
